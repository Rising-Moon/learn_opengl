...
//片元着色器2
char FRAGMENT2_SHADER[1024] = "";

int main(void) {
    //读取顶点着色器代码
    readFile("../HomeWork/1_4/q3/vertex_shader.vert", VERTEX_SHADER);
    //读取片元着色器代码
    readFile("../HomeWork/1_4/q3/fragment_shader.frag", FRAGMENT_SHADER);
    //读取片元着色器2代码
    readFile("../HomeWork/1_4/q3/fragment2_shader.frag", FRAGMENT2_SHADER);
    ...
    unsigned int fragment2Shader = createShader(FRAGMENT2_SHADER, GL_FRAGMENT_SHADER);
    //创建着色器程序
    unsigned int program = createProgram(vertexShader, fragmentShader);
    unsigned int program2 = createProgram(vertexShader, fragment2Shader);
    //卸载着色器
...
//绘制
void draw(unsigned int program, unsigned int program2) {
    //顶点数据
    float vertices1[] = {
            0.5f, -0.5f, 0.0f,
            -0.5f, -0.5f, 0.0f,
