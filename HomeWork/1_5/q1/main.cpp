...
int main(void) {
    //读取顶点着色器代码
    readFile("../HomeWork/1_5/q1/vertex_shader.vert", VERTEX_SHADER);
    //读取片元着色器代码
    readFile("../HomeWork/1_5/q1/fragment_shader.frag", FRAGMENT_SHADER);
...
void draw(unsigned int program) {
    ...
    glad_glUniform4f(fragColorLocation, 0.0f, greenValue, 0.0f, 1.0f);
