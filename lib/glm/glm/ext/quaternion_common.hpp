...
namespace glm
{
	...
	/// The interpolation is oriented and the rotation is performed at constant g_MoveSpeed.
	...
	/// Spherical linear interpolation of two quaternions.
	/// The interpolation always take the short path and the rotation is performed at constant g_MoveSpeed.
	///
	/// @param x A quaternion
	/// @param y A quaternion
	/// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
    ...
    /// when count is negative. Rotation is performed at constant g_MoveSpeed.
    ///
    /// @param x A quaternion
    /// @param y A quaternion
    /// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
